        ...
        <div class="modal-content">
            ...
            <form class="form" action="javascript:void(0)" id="kt_modal_update_brand_form"
                ...
                <div class="modal-header" id="kt_modal_add_customer_header">
                    <!--begin::Modal title-->
                    <h2 class="fw-bolder">{{__('Cập nhật Thương hiệu')}}</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                ...
                <div class="modal-body py-10 px-lg-17">
                    ...
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" class="form-control form-control-sm form-control-solid" id="name-input-update" placeholder="{{__('Nhập tên brand')}}" name="name"
                                value="" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
