...
<div class="card card-flush">
    ...
    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
        ...
        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
            ...
            <!--begin::Add customer-->
            <button type="button" data-bs-toggle="modal" data-bs-target="#kt_modal_add_brand"  class="btn btn-sm btn-primary">Thêm mới</button>
            <!--end::Add customer-->
        </div>
        <!--end::Card toolbar-->
    </div>
...
@include('admin.brand.modal_create')
@include('admin.brand.modal_update')

@endsection
@section('pageJs')
    <script src="{{ url('admin/assets/js/pages/brand.js') }}"></script>
    <script>
