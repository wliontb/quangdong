        ...
        <div class="card card-flush py-4">
            ...
            <div class="card-body text-center pt-0">
                ...
                <div class="image-input image-input-empty image-input-outline mb-3" data-kt-image-input="true" style="background-image: url(assets/media/svg/files/blank-image.svg)">
                    ...
                    <div class="image-input-wrapper w-150px h-150px" style="background-image: url({{ asset('storage/' . $product->thumb) }})"></div>
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="product_name" class="form-control form-control-sm mb-2" placeholder="{{__('Tên sản phẩm')}}" value="{{$product->product_name}}" />
                                <!--end::Input-->
                                <!--begin::Description-->
                            ...
                            <div class="mb-10">
                                ...
                                <!--end::Label-->
                                <!--begin::Editor-->
                                <input type="text" name="summary" class="form-control form-control-sm mb-2" placeholder="{{__('Tóm tắt sản phẩm')}}" value="{{$product->summary}}" />
                                <!--end::Editor-->
                                <!--begin::Description-->
                        ...
                        <div class="card-body pt-0">
                            <div id="no-variation">
                                <div class="mb-10 fv-row">
                                    ...
                                    <input type="text" name="price" id="price-product" data-plugin="inputmask-numeric" class="form-control form-control-sm mb-2" placeholder="{{__('Ví dụ: 100000')}}" value="{{$product->price}}">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <input type="text" name="quantity" id="quantity-product" data-plugin="inputmask-numeric" class="form-control form-control-sm mb-2" placeholder="{{__('Ví dụ: 50')}}" value="{{$product->quantity}}">
                                    <div class="text-muted fs-7">{{__('Nhập số lượng sản phẩm.')}}</div>
                                </div>
                                <div class="mb-10 fv-row">
                                    <label class="form-label" for="sku-product">{{__('Mã code sản phẩm')}}</label>
                                    <input type="text" name="sku" id="sku-product" class="form-control form-control-sm mb-2" placeholder="{{__('Ví dụ: BL-07')}}" value="{{$product->sku}}">
                            ...
                            <div class="fv-row mb-2">
                                ...
                                <div class="dropzone  {{ $product->medias->isNotEmpty() ? 'dz-started' : '' }}" id="kt_ecommerce_add_product_media">
                                    ...
                                    <div class="dz-preview dz-processing dz-image-preview dz-complete custom-dropzone-img">
                                        <div class="dz-image">
                                            <img data-dz-thumbnail="" alt="{{ $media->alt }}" src="{{ 'storage/' . $media->url }}" width="120" height="120">
                                        </div> 
