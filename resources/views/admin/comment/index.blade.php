...
<div class="card card-flush">
    ...
    <!--end::Card header-->
    <!--begin::Card body-->
    <div class="card-body pt-0" id="table-comment">
        <!--begin::Table-->
...
<!--end::Category-->
@include('admin.comment.modal_update')
@endsection

@section('pageJs')
    <script src="{{ url('admin/assets/js/pages/comment.js') }}"></script>
    <script>
        $(document).ready(function() {
            var instance = new CommentClass();
            instance.run();
        });
    </script>
@endsection