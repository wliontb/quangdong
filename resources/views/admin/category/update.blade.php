...
@section('breadcrumb')
{{ Breadcrumbs::render('category_update', $category) }}
@endsection
...
<form id="kt_ecommerce_add_category_form" action="javascript:void(0)" class="form d-flex flex-column flex-lg-row" >
    ...
    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
        ...
        <div class="card card-flush py-4">
            ...
            <div class="card-body pt-0">
                <!--begin::Select2-->
                <select class="form-select form-select-sm mb-2" data-control="select2" data-hide-search="true" data-placeholder="Select an option" id="kt_ecommerce_add_category_status_select">
                    <option></option>
                    <option value="1" {{$category->active == 1 ? 'selected' : ''}}>{{__('Active')}}</option>
                    <option value="0" {{$category->active == 0 ? 'selected' : ''}}>{{__('Inactive')}}</option>
                </select>
                <!--end::Select2-->
                <!--begin::Description-->
        ...
        <div class="card card-flush py-4">
            ...
            <div class="card-body pt-0">
                ...
                <select class="form-select form-select-sm mb-2" data-control="select2" data-hide-search="true" data-placeholder="{{__('Chọn một option')}}" id="kt_ecommerce_add_category_store_template">
                    <option value="no_parent" {{$category->parent_id == null ? 'selected' : ''}}>{{__('Không có danh mục cha')}}</option>
    ...
    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
        ...
        <div class="card card-flush py-4">
            ...
            <div class="card-body pt-0">
                ...
                <div class="mb-10 fv-row">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" name="category_name" class="form-control form-control-sm mb-2" placeholder="{{__('Nhập tên danh mục')}}" value="{{$category->name}}" />
                    <!--end::Input-->
                    <!--begin::Description-->
        ...
        <div class="d-flex justify-content-end">
            ...
            <!--end::Button-->
            <!--begin::Button-->
            <button type="submit" data-type="update" id="kt_ecommerce_add_category_submit" class="btn btn-sm btn-primary">
