<div class="modal fade" id="kt_modal_update_promotion" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <!--begin::Modal content-->
        <div class="modal-content">
            <!--begin::Form-->
            <form class="form" action="javascript:void(0)" id="kt_modal_update_promotion_form"
                data-kt-redirect="../../demo1/dist/apps/customers/list.html">
                <!--begin::Modal header-->
                <div class="modal-header" id="kt_modal_update_customer_header">
                    <!--begin::Modal title-->
                    <h2 class="fw-bolder">Cập nhật Khuyến mãi</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                ...
                <div class="modal-body py-10 px-lg-17">
                    ...
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_update_customer_scroll" data-kt-scroll="true"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" class="form-control form-control-sm form-control-solid" id="name-input-update" placeholder="Nhập tên Khuyến mãi" name="name-update"
                                value="" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <textarea name="description" id="description-input-update" class="form-control form-control-sm form-control-solid" cols="30" rows="10"></textarea>
                            <!--end::Input-->
                        </div>
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="number" min="0" max="100" class="form-control form-control-sm form-control-solid" id="discount-input-update" placeholder="Nhập giá trị khuyến mãi" name="discount-update"
                                value="" />
                            <!--end::Input-->
                        </div>
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <select class="form-select form-select-sm mb-2" data-control="select2" data-hide-search="false" name="product-update[]" multiple data-placeholder="{{__('Chọn sản phẩm')}}" id="kt_ecommerce_udpate_category_store_template">
                        ...
                        <div class="fv-row mb-7">
                            <!--begin::Image input-->
                            <div class="image-input image-input-empty image-input-outline mb-3" data-kt-image-input="true" id="thumb-update" style="background-image: url(admin/assets/media/svg/files/blank-image.svg)">
                        ...
                        <input type="number" hidden name="pid" id="pid-update" value="">
                    </div>
                    <!--end::Scroll-->
                </div>
                <!--end::Modal body-->
                ...
                <div class="modal-footer flex-center">
                    ...
                    <!--end::Button-->
                    <!--begin::Button-->
                    <button type="submit" id="kt_modal_update_promotion_submit" class="btn btn-sm btn-primary">
