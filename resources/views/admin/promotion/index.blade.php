...
<div class="card card-flush">
    ...
    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
        ...
        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
            ...
            <!--begin::Add customer-->
            <button type="button" data-bs-toggle="modal" data-bs-target="#kt_modal_add_promotion"  class="btn btn-sm btn-primary">Thêm mới</button>
            <!--end::Add customer-->
        </div>
        <!--end::Card toolbar-->
    </div>
    <!--end::Card header-->
    <!--begin::Card body-->
    <div class="card-body pt-0" id="kt_ecommerce_promotion_table">
        <!--begin::Table-->
        <!--end::Table-->
    </div>
    <!--end::Card body-->
...
@include('admin.promotion.modal_create')
@include('admin.promotion.modal_update')

@endsection
@section('pageJs')
    <script src="{{ url('admin/assets/js/pages/promotion.js') }}"></script>
    <script>
        $(document).ready(function() {
            var instance = new PromotionClass();
            instance.run();
        });
    </script>
@endsection