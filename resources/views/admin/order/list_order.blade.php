<table class="table align-middle table-row-dashed fs-6 gy-5" >
    ...
    <tbody class="fw-bold text-gray-600">
        ...
        <tr>
            <td><a href="{{ route('admin.order.detail', ['id' => $order->id]) }}">{{$order->code}}</a></td>
            ...
            <td class="text-end">
                <button class="btn btn-icon btn-active-light-primary w-30px h-30px me-3 update-btn" data-bs-toggle="modal" data-id="{{$order->id}}"
                    data-bs-target="#kt_modal_update_order" title="{{__('Cập nhật')}}">
                ...
                <button class="btn btn-icon btn-active-light-primary w-30px h-30px delete-btn" data-id="{{$order->id}}" title="{{__('Xóa')}}"
