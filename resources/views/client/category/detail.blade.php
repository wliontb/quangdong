        ...
        <div class="secion" id="breadcrumb-wp">
            <div class="secion-detail">
                <ul class="list-item clearfix">
                    ...
                    @if ($category->parent)
                    <li>
                        <a href="{{ route('category.detail', ['id' => $category->parent_id, 'slug' => \Str::slug($category->parent->name)]) }}" title="">{{ $category->parent->name }}</a>
                    </li>
                    @endif
                    <li>
                        <a href="javascript:;" title="">{{ $category->name }}</a>
                    </li>
                </ul>
            </div>
        </div>
...
@section('pageJs')
    <script src="{{ url('client/js/pages/category.js') }}"></script>
    <script>
        $(document).ready(function() {
            var instance = new CategoryClientClass();
            instance.run({
